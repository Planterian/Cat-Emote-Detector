...
def load_reference_images():
    ...
    pose_images = {
        "Laughing": "cat_laughing.jpg",
        "Absolute_Cinema": "cat_absolute_cin.jpg", 
        "Crying": "cat_crying.jpg",
        "Like": "cat_like.png",
        "Pointing": "cat_pointing.jpg",
        "Punching": "saitama.jpg"
    }
...
def play_pose_sound(pose_name):
    ...
    try:
        ...
        sound_files = {
            "Laughing": "cat_laughing.mp3",
            "Absolute_Cinema": "cat_absolute_cin.mp3",
            "Crying": "cat_crying.mp3",
            "Like": "cat_like.mp3",
            "Pointing": "cat_pointing.mp3",
            "Punching": "one_punch.mp3"
        }
...
def main():
    ...
    last_sound_time = 0
    sound_cooldown = 10  # Minimum time between sounds in seconds
