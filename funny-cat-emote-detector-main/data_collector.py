...
class PoseDataCollector:
    def __init__(self, data_dir="pose_data"):
        ...
        print("  '1' - Set pose to Absolute_Cinema") 
        print("  '2' - Set pose to Crying")
        print("  '3' - Set pose to Like")
        print("  '4' - Set pose to Pointing")
        print("  '5' - Set pose to Punching")
    ...
    def collect_data(self):
        ...
        while True:
            ...
            cv2.putText(frame, "Press 0-4 to change pose, 'a' to toggle auto-collect", 
    ...
    def load_sample_data(self):
        ...
        if X is None:
            ...
            print("2. Collect samples for each pose (press 0-5 to select pose, 'a' to auto-collect)")
