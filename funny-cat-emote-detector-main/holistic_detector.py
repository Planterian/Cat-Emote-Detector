...
class HolisticDetector:
    ...
    def draw_landmarks(self, frame, results):
        ...
        # self.mp_drawing.draw_landmarks( turn off landmarks cause it will collide with the key points
        #     frame,
        ...
        if results.face_landmarks:
            ...
            # Draw key points: nose, eyes, mouth
            key_points = [
                        1, 4, 5, 112, 190, 56, 28, 27, 29, 30, 247, 226, 31, 228, 229, 230, 231, 232,
                        463, 414, 286, 258, 257, 259, 260, 467, 446, 255, 339, 254, 253, 252, 256, 341,
                        0, 37, 39, 40, 185, 62, 146, 91, 181, 84, 17, 314, 405, 321, 375, 308, 409,
                        270, 269, 267
                    ] # Nose, mouth, eyes
